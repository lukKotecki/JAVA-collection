		...
		try{
			...
			for(int y=0; y<HEIGHT; y++){
				for(int x=0; x<WIDTH; x++){
					...
					//Color grayColor = new Color(roznica,suma,suma);//red
					//Color grayColor = new Color(suma,roznica,suma);//green
					Color grayColor = new Color(roznica,roznica,suma);//blue
					
					//Color grayColor = new Color(red+green+blue,red+green+blue,red+green+blue);
