		...
		do{
			try{
				for(int i = 0; i<NUMBER_OF_PHOTOS;i++){
					file.add(i,new File("photo_"+(i+1)+".jpg"));
					image.add(i,ImageIO.read(file.get(i)));
					System.out.println("photo_"+(i+1)+".jpg");
				}
				...
				System.out.println("Error! Unable to upload files. Required names: \"photo_1.jpg\", \"photo_2.jpg\" and \"photo_3.jpg\" ....");
				e.printStackTrace();
